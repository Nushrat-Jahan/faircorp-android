...
class RoomCallbackFunctions(private val listener: RoomListener): RecyclerView.Adapter<RoomCallbackFunctions.RoomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RoomViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_room_list, parent, false)
